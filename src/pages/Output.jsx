      ...
      <div className="bg-slate-50 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/60 p-4 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex-1">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Separate cysteines into high & low probability categories.
          </p>
        </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors cursor-pointer shadow-sm animate-fade-in"
          >
            <Download className="w-3.5 h-3.5" />
